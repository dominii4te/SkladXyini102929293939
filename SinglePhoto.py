...
# Установи в True чтобы увидеть разбивку времени по этапам в логах
DEBUG_TIMING = True
...
class FaceSwapper:
    ...
    def swap_faces(self, source_path, source_face_idx, target_path, target_face_idx):
        ...
        if DEBUG_TIMING:
            print(f"[TIMING] imread={t1-t0:.3f}s | source_face={t2-t1:.3f}s | "
                  f"target_detect={t3-t2:.3f}s | swap={t4-t3:.3f}s | TOTAL={t4-t0:.3f}s")
